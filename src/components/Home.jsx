...
import logo from "../images/Screenshot_2024-10-01_at_1.21.59_PM-removebg-preview.png"
import ME from "../images/Untitled-NJXyBb8Qp-transformed 2.jpg"
import LINE from "../images/separatorBlack 1.png"
import HTML from "../images/vecteezy_stylized-3d-html-logo-design_12697299 (1).png"
import CSS from "../images/vecteezy_3d-css-icon-design_12697301.png"
import JAVA from "../images/vecteezy_3d-javascript-logo-design_12697298.png"
import TAILWIND from "../images/Screenshot_2024-10-02_at_5.06.37_PM-removebg-preview.png"
import React from "../images/vecteezy_3d-icon-of-atom_20033019.png"
import nodeJs from "../images/Screenshot_2024-10-02_at_5.02.56_PM-removebg-preview.png"
import MONGO from "../images/Screenshot_2024-10-02_at_5.10.51_PM-removebg-preview.png"
import EXPRESS from "../images/Screenshot_2024-10-02_at_5.41.39_PM-removebg-preview.png"
import word from "../images/Screenshot_2024-10-02_at_7.40.09_PM-removebg-preview.png"
import APP from "../images/Screenshot_2024-10-02_at_7.49.06_PM-removebg-preview.png"
import ENGLISH from "../images/Screenshot_2024-10-02_at_8.14.18_PM-removebg-preview.png"
import ARABIC from "../images/Screenshot_2024-10-02_at_8.12.11_PM-removebg-preview.png"
    ...
    return <div className=" font-Body " >
        ...
        <div className="" >
                <div  className=" bg-black  sm:h-[80px]  h-full w-full   flex  sm:justify-around  " >
                    <img id="UL" className= " h-[50px]  mt-[10px] sm:ml-[0px] ml-[30px] sm:pb-0 pb-[10px]  " src={logo} alt="" />
                ...
                <div className="  flex  ">
                        ...
                        <div>
                            <img  id="me" className="    absolute sm:h-[650px] h-[400px] overflow-visible sm:top-[100px]   top-[300px]  sm:left-[700px] sm:bottom-[110px] left-[5px]   " src={ME} alt="" />
                        </div>
                </div>
        ...
        <section id="About" >
            <div className="  h-screen    " >
               <div className=" pt-[50px]  " >
                    ...
                    <img className=" ml-[120px] sm:ml-[640px] mt-[20px]  " src={LINE} alt="" />    
               </div>
            ...
            <img className=" sm:ml-[640px] ml-[120px] mt-[150px] pb-[100px]  " src={LINE} alt="" />
               ...
               <div  className=" font-Body   ">
                    ...
                    <div>
                        ...
                        <div className="grid sm:grid-cols-4 grid-cols-3 gap-[10px] sm:ml-[300px]  ml-[30px]   " >
                            <div>
                                <img className="sm:h-[80px]   h-[50px]  hover:scale-110 duration-150     " src={HTML} alt="" />
                                <h1 className=" mt-[20px] font-semibold  text-black  " >HTML</h1>
                            </div>
                            <div>
                                <img className="sm:h-[80px]  h-[50px]   hover:scale-110 duration-150    " src={CSS} alt="" />
                                <h1 className=" mt-[20px] font-semibold  text-black  " >CSS</h1>
                            </div>
                            <div>
                                <img className="sm:h-[80px]  h-[50px]   hover:scale-110 duration-150    " src={JAVA} alt="" />
                                <h1 className=" mt-[20px] font-semibold text-black  " >JavaScript</h1>
                            </div>
                            <div>
                                <img className="sm:h-[80px]  h-[50px]   hover:scale-110 duration-150    " src={TAILWIND} alt="" />
                                <h1 className=" mt-[20px] font-semibold  text-black  " >Tailwind Css</h1>
                            </div>
                            <div>
                                <img className="sm:h-[80px]  h-[50px]   hover:scale-110 duration-150    " src={React} alt="" />
                                <h1 className=" mt-[20px] font-semibold  text-black  " >React</h1>
                            </div>
                            <div>
                                <img className="sm:h-[80px]  h-[50px]   hover:scale-110 duration-150    " src={nodeJs} alt="" />
                                <h1 className=" mt-[20px] font-semibold  text-black  " >NodeJS </h1>
                            </div>
                            <div>
                                <img className="sm:h-[100px]  h-[50px]   hover:scale-110 duration-150    " src={MONGO} alt="" />
                                <h1 className=" mt-[20px] font-semibold  text-black  " > MongoDB </h1>
                            </div>
                            <div>
                                <img className="sm:h-[80px]  h-[50px]   hover:scale-110 duration-150    " src={EXPRESS}  alt="" />
                    ...
                    <div className="grid grid-cols-3 gap-[20px] sm:ml-[300px] ml-[30px] sm:pt-0 pt-[30px]    " >
                            <div  >
                                <img className="sm:h-[80px] h-[50px]   hover:scale-110 duration-150     " src={word} alt="" />
                                <h1 className=" mt-[20px] font-semibold  text-black  " > Wordpress </h1>
                            </div>

                            <div>
                                <img className="sm:h-[80px]  h-[50px] hover:scale-110 duration-150    " src={APP} alt="" />
                    ...
                    <div className="grid grid-cols-3 gap-[20px] sm:ml-[300px]  ml-[30px] pt-[30px]    " >
                            <div>
                                <img className="sm:h-[80px]  h-[50px]   hover:scale-110 duration-150    " src={ENGLISH} alt="" />
                                <h1 className=" mt-[20px] font-semibold  text-black  " >English  </h1>
                            </div>

                            <div>
                                <img className=" sm:h-[80px] h-[50px]   hover:scale-110 duration-150    " src={ARABIC} alt="" />
