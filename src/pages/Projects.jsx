...
import EXAM  from "../images/Screenshot 2024-10-03 at 10.06.31 AM.png"
import E  from "../images/Screenshot 2024-10-03 at 9.57.57 AM.png"
import APP from "../images/Screenshot 2024-10-03 at 1.41.25 PM.png"
import NOTE from "../images/Screenshot 2024-10-03 at 1.51.29 PM.png"
...
function Project (){
    return <div>
        <div className=" bg-black  h-[80px] w-full flex justify-around  " >
                ...
                <img id="UL"  className= " h-[50px]  mt-[10px] sm:ml-[-109px]   " src={logo} alt="" />
        ...
        <div   className=" grid grid-cols-1 sm:grid-cols-3  gap-[20px] sm:ml-[20px] mt-[20px]  "  >
            <div id="me"  className=" border-[white] text-center border-[3px] bg-black  rounded-[10px]  h-[300px]  "   >
                ...
                <img className="sm:h-[200px]  h-[180px]   mt-[20px] ml-[40px] hover:scale-105 duration-150     " src={EXAM} alt="" />
            </div>

            <div id="me" className=" border-[white] text-center border-[3px] bg-black  rounded-[10px]  h-[300px]  "  >
                <h1 className=" text-white font-Body font-semibold text-[20px] pt-[10px]  " >E-Commerce</h1>
                <img className="sm:h-[200px]  h-[180px]  mt-[20px] ml-[40px] hover:scale-105 duration-150      " src={E} alt="" />
            </div>

            <div id="me"  className=" border-[white] text-center border-[3px] bg-black  rounded-[10px]  h-[300px]  " >
                <h1 className=" text-white font-Body font-semibold text-[20px] pt-[10px]  " >Voting App</h1>
                <img className="sm:h-[200px]  h-[180px] mt-[20px]  ml-[40px] hover:scale-105 duration-150      " src={APP} alt="" />
            </div  >
            <div id="me" className=" border-[white] text-center border-[3px] bg-black  rounded-[10px]  h-[300px]  " >
                <h1 className=" text-white font-Body font-semibold text-[20px] pt-[10px]  " >Note Taker App</h1>
                <img className="sm:h-[200px]  h-[180px] mt-[20px]  ml-[40px] hover:scale-105 duration-150      " src={NOTE} alt="" />
            </div  >
